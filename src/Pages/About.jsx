  ...
  return (
    <div className="min-h-screen">
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl mb-4">
              Hi, I’m <span className="font-semibold">Pranay Jha</span>, a passionate developer and sports enthusiast. 
              I created <span className="font-semibold">BuyBox</span> to combine my love for technology and sports, 
              making it easier for players to find the gear they need. My goal is to provide a seamless shopping experience backed by dedication and innovation.
            </p>
            <button
      ...
      <section className="py-16 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-12">Why Choose BuyBox?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition">
              <h3 className="text-xl font-semibold mb-2">Quality Gear</h3>
              <p>Only premium brands selected for performance and durability.</p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition">
              <h3 className="text-xl font-semibold mb-2">Fast Delivery</h3>
              <p>Get your sports essentials delivered quickly to your doorstep.</p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition">
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900 text-white text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-6">
            Explore our collection of premium sports gear and get the advantage you deserve.
          </p>
          <button
            onClick={() => navigate("/product")}
